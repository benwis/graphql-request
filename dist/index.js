...
exports.gql = exports.request = exports.rawRequestResponse = exports.rawRequest = exports.GraphQLClient = exports.ClientError = void 0;
...
var GraphQLClient = /** @class */ (function () {
    ...
    GraphQLClient.prototype.rawRequestResponse = function (query, variables, requestHeaders) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, headers, _b, localFetch, others, body, response;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = this.options, headers = _a.headers, _b = _a.fetch, localFetch = _b === void 0 ? cross_fetch_1.default : _b, others = __rest(_a, ["headers", "fetch"]);
 ...
 * @param variables
 */
function rawRequestResponse(url, query, variables) {
    return __awaiter(this, void 0, void 0, function () {
        var client;
        return __generator(this, function (_a) {
            client = new GraphQLClient(url);
            return [2 /*return*/, client.rawRequestResponse(query, variables)];
        });
    });
}
exports.rawRequestResponse = rawRequestResponse;
/**
