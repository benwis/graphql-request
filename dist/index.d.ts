...
export declare class GraphQLClient {
    ...
    rawRequestResponse<T = any, V = Variables>(query: string, variables?: V, requestHeaders?: Dom.RequestInit['headers']): Promise<Dom.Response>;
    /**
 ...
 * @param variables
 */
export declare function rawRequestResponse<T = any, V = Variables>(url: string, query: string, variables?: V): Promise<Dom.Response>;
/**
